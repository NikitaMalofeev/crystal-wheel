...
const SYMBOL_URLS = [
  ...
  'symbols/symbo2.png.jpg',
  'symbols/symbo3.png.jpg',
  'symbols/symbo4.png.jpg',
  'symbols/symbo5.png.jpg',
  'symbols/symbo6.jpg',
  'symbols/symbo7.jpg',
  'symbols/symbo8.jpg',
];
...
const INITIAL_OFFSET = -Math.PI / 2; // Смещение на 90 градусов против часовой стрелки
...
const Indicator: React.FC<{ isSpinning: boolean }> = ({ isSpinning }) => {
  ...
  useEffect(() => {
    if (isSpinning && arrowRef.current) {
      // Анимация стрелки во время вращения
